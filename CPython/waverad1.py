...
for line in lines:
    ...
    # be fixed, applying the discovered date to previous lines.
        ...
        try:
            ...
            # If midnight was detected between the last GPS fix and now,
            # reject this data (TODO: Go to the next day, maybe month and year)
            if last_hour == 23 and when_struct[3] == 0:
                midnight_no_fix_yet = True
            last_hour = when_struct[3]
